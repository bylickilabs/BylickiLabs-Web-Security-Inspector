...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Technische Architektur** innerhalb des BylickiLabs Web Security Inspector.
...
- **Pyside6-hauptfenster und tab-navigation:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Zentrale scan-engine:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Sqlite-historie:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Reporting-schicht:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Internationalisierung:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
