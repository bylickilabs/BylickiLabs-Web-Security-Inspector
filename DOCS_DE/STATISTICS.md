...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Statistische Auswertung** innerhalb des BylickiLabs Web Security Inspector.
...
- **Mittelwert und median:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Standardabweichung und perzentile:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Shannon-entropie:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Regression und trend:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Z-score-ausreißer:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
