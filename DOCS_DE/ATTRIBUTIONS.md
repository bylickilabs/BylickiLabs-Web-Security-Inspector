...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Quellen und Zuordnungen** innerhalb des BylickiLabs Web Security Inspector.
...
Externe Bibliotheken, Symbole, Grafiken, Dokumentationsquellen und technische Referenzen müssen mit Name, Herkunft, Lizenz und Verwendungszweck dokumentiert werden. Emojis und deren Bezeichnungen können unter anderem über Emojipedia referenziert werden.
