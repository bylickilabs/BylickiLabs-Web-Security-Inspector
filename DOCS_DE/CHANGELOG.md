...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Änderungsverlauf** innerhalb des BylickiLabs Web Security Inspector.
...
- **Versionsplanung, freigabestatus und nachvollziehbare änderungsstände:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Kompatibilität, migration und kontrollierte veröffentlichung:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Prüfung von release-artefakten, build-ergebnissen und versionsnummern:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Dokumentation von änderungen, einschränkungen und bekannten risiken:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Abstimmung zwischen entwicklung, test, sicherheit und bereitstellung:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
...
- vollständig neu entwickelte PySide6-Benutzeroberfläche
- Dashboard, Scan Center, Befunde, Statistik, Verlauf, Protokoll und Einstellungen
- NumPy- und SciPy-Auswertungen
- Matplotlib-Diagramme
- SQLite-Scan-Historie
- Exporte in JSON, HTML, CSV, PDF und SARIF
- automatisierte Windows-Build-Skripte mit PyInstaller
- deutsch- und englischsprachige Oberfläche

### Geändert

- Scan-Engine modularisiert
- Risikoscore auf ein abflachendes Bewertungsmodell umgestellt
- Datenbankzugriffe und Ergebnisaggregation optimiert
- dynamische Inhalte in UI und Berichten sicherer verarbeitet
- Behandlung von IP-Zielen und DNS-Sonderfällen verbessert

### Korrigiert

- Verzögerungen bei IP-basierten Zielen
- Sonderzeichen in HTML- und PDF-Berichten
- Stabilität bei leeren Messreihen und fehlerhaften externen Antworten
