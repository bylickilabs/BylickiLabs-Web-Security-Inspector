...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Teststrategie** innerhalb des BylickiLabs Web Security Inspector.
...
- **Pytest:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Ruff:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Syntaxprüfung:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Scanner- und datenbanktests:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Export- und statistiktests:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
