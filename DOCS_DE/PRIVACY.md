...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Datenschutzrichtlinie** innerhalb des BylickiLabs Web Security Inspector.
...
- **Lokale scan-historie:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Einstellungen:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Berichte:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Optionale externe apis:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Datenminimierung:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
