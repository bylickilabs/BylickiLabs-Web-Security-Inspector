...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Haftungsausschluss** innerhalb des BylickiLabs Web Security Inspector.
...
- **Urheberrecht, lizenzen und zulässige nutzung von projektbestandteilen:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Korrekte zuordnung von drittanbieterbibliotheken, grafiken und quellen:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Schutz der namen bylickilabs und bylickilabs web security inspector:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Haftungsgrenzen, eigenverantwortung und rechtmäßige nutzung:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Nachvollziehbare dokumentation externer rechte und verpflichtungen:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
...
## Wesentliche Haftungsgrenzen

Die Anwendung wird ohne Garantie einer vollständigen Schwachstellenerkennung bereitgestellt. Ergebnisse können unvollständig, zeitabhängig oder fehlerhaft sein. Die Auswahl von Zielsystemen, die rechtliche Freigabe, die Bewertung der Befunde und die Umsetzung von Maßnahmen liegen ausschließlich beim Anwender.
