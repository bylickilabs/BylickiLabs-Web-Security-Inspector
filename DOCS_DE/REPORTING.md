...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Berichtswesen und Exporte** innerhalb des BylickiLabs Web Security Inspector.
...
- **Json:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Html:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Csv:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Pdf:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Sarif 2.1.0:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
...
| HTML | eigenständiger Business-Bericht |
| CSV | tabellarische Weiterverarbeitung |
| PDF | Management- und Archivbericht |
| SARIF 2.1.0 | Entwicklungs- und Security-Integration |
