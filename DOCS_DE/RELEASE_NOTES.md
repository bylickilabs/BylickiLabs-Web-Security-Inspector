...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Versionshinweise** innerhalb des BylickiLabs Web Security Inspector.
...
Diese Version stellt eine vollständige Neuentwicklung dar. Sie verbindet modulare Web-Security-Prüfungen, statistische Auswertungen, lokale Datenhaltung, mehrformatige Berichte und einen automatisierten Windows-Build in einer gemeinsamen Desktop-Anwendung.
