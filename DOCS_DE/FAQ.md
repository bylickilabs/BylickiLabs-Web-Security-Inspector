...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Häufig gestellte Fragen** innerhalb des BylickiLabs Web Security Inspector.
...
### Benötigt die EXE eine separate Python-Installation?

Nein. Eine korrekt erstellte PyInstaller-Version enthält die benötigten Laufzeitkomponenten.

### Wo werden Scan-Verläufe gespeichert?

Standardmäßig in `data/scan_history.sqlite3`.

### Können externe APIs deaktiviert werden?

Ja. PageSpeed Insights und MDN HTTP Observatory sind optional.

### Ersetzt die Anwendung eine manuelle Sicherheitsprüfung?

Nein. Automatisierte Ergebnisse müssen fachlich bewertet werden.

### Welche Ziele dürfen geprüft werden?

Eigene Systeme und ausdrücklich freigegebene Prüfziele.
