...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Build-Anleitung** innerhalb des BylickiLabs Web Security Inspector.
...
- **Python 3.11+, pyside6 und klar getrennte module:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Automatisierte tests mit pytest und codeanalyse mit ruff:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Reproduzierbare windows-builds mit pyinstaller:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Zweisprachige texte und konsistente technische dokumentation:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Sichere verarbeitung von urls, dateien, datenbanken und dynamischen inhalten:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Pyinstaller:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Spec-datei:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Ressourcen und symbol:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Build-bereinigung:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Dist-verzeichnis:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
