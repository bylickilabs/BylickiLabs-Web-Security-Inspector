...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Datenmodell** innerhalb des BylickiLabs Web Security Inspector.
...
- **Scanresult:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Finding:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Measurement:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Severity und confidence:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Serialisierbare exportdaten:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
