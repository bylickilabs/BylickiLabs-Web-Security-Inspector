...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Veröffentlichungsprozess** innerhalb des BylickiLabs Web Security Inspector.
...
3. Tests und Ruff vollständig ausführen.
4. Windows-Build erzeugen.
5. Anwendung und Exporte manuell prüfen.
6. Prüfsummen erzeugen.
7. Changelog und Release Notes aktualisieren.
8. Tag und Release veröffentlichen.
9. Artefakte aus offizieller Quelle bereitstellen.
