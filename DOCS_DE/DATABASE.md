...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Datenbankkonzept** innerhalb des BylickiLabs Web Security Inspector.
...
- **Scan-metadaten:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Befunde:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Messreihen:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Transaktionen und indizes:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Löschung und wiederherstellung:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
