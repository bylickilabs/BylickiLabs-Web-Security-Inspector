...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Portable Windows-Version** innerhalb des BylickiLabs Web Security Inspector.
...
Die portable Windows-Version wird aus dem vollständigen PyInstaller-Verzeichnis unter `dist/BylickiLabsWebSecurityInspector/` bereitgestellt. Der gesamte Ordner muss unverändert übertragen werden. Einzelne Dateien dürfen nicht isoliert kopiert werden.
