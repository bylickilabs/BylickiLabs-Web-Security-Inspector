...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Risikomodell** innerhalb des BylickiLabs Web Security Inspector.
...
- **Schweregradgewichtung:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Vertrauensniveau:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Abflachende score-berechnung:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **A-bis-e-bewertung:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Manuelle fachliche einordnung:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
