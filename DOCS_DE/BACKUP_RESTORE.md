...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Sicherung und Wiederherstellung** innerhalb des BylickiLabs Web Security Inspector.
...
Vor einer Wiederherstellung muss die Anwendung beendet sein. Datenbankdateien dürfen nicht während eines laufenden Schreibvorgangs ersetzt werden.
