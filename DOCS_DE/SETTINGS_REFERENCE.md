...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Einstellungsreferenz** innerhalb des BylickiLabs Web Security Inspector.
...
- **Reproduzierbare installation und zuverlässiger programmstart unter windows:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Klare bedienabläufe für scan center, dashboard, befunde und statistik:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Sichere lokale speicherung von einstellungen, scans und berichten:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Nachvollziehbare fehlerdiagnose, wiederherstellung und supportinformationen:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Kontrollierte nutzung optionaler externer dienste und api-schlüssel:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Sprache:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Netzwerkzeitlimit:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Messanzahl:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Lokale speicherung:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
- **Optionale api-dienste:** wird verbindlich beschrieben, fachlich eingeordnet und regelmäßig überprüft.
...
| Netzwerkzeitlimit | maximale Wartezeit einzelner Netzwerkanfragen |
| Messanzahl | Anzahl der Performance-Messungen |
| Lokale Speicherung | Aktivierung der SQLite-Scan-Historie |
| PageSpeed | optionale externe Analyse |
| Observatory | optionale externe HTTP-Bewertung |
