...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Entwicklungsroadmap** innerhalb des BylickiLabs Web Security Inspector.
...
- Vergleich zweier Scan-Ergebnisse
- verbesserte Filter und gespeicherte Ansichten
- zusätzliche TLS- und DNS-Auswertungen
- optimierte PDF-Berichte

### Version 2.2

- Projekt- und Mandantenverwaltung
- konfigurierbare Scan-Vorlagen
- erweiterte SARIF-Integration
- zusätzliche Statistikansichten

### Version 3.0

- optionale Plugin-Schnittstelle
- erweiterte API-Analyse
- kontrollierte CI-Integration
- zentrale Richtlinien für größere Prüfbestände
