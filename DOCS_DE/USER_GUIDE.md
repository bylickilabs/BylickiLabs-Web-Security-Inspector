...
Diese Datei definiert die verbindlichen Anforderungen, Abläufe, Zuständigkeiten und Qualitätsmaßstäbe für den Bereich **Benutzerhandbuch** innerhalb des BylickiLabs Web Security Inspector.
...
1. Anwendung starten.
2. Sprache und Einstellungen prüfen.
3. Zieladresse im Scan Center eintragen.
4. Quick, Standard oder Extended auswählen.
5. Analyse starten und Statusmeldungen verfolgen.
6. Risikoscore und Kennzahlen im Dashboard prüfen.
7. Befunde filtern und Detailansichten öffnen.
8. Statistik und historische Entwicklung auswerten.
9. Bericht im gewünschten Format exportieren.
10. Scan-Historie bei Bedarf verwalten.
