...
This file defines the binding requirements, procedures, responsibilities, and quality standards for **Testing Strategy** within BylickiLabs Web Security Inspector.
...
- **Python 3.11+, PySide6, and clearly separated modules:** is defined, professionally assessed, and reviewed on a regular basis.
- **Automated tests with pytest and code analysis with Ruff:** is defined, professionally assessed, and reviewed on a regular basis.
- **Reproducible Windows builds with PyInstaller:** is defined, professionally assessed, and reviewed on a regular basis.
- **Bilingual text and consistent technical documentation:** is defined, professionally assessed, and reviewed on a regular basis.
- **Secure processing of URLs, files, databases, and dynamic content:** is defined, professionally assessed, and reviewed on a regular basis.
- **Pytest:** is defined, professionally assessed, and reviewed on a regular basis.
- **Ruff:** is defined, professionally assessed, and reviewed on a regular basis.
- **Syntax validation:** is defined, professionally assessed, and reviewed on a regular basis.
- **Scanner and database tests:** is defined, professionally assessed, and reviewed on a regular basis.
- **Export and statistics tests:** is defined, professionally assessed, and reviewed on a regular basis.
