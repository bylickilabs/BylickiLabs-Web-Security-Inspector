...
This file defines the binding requirements, procedures, responsibilities, and quality standards for **Portable Windows Version** within BylickiLabs Web Security Inspector.
...
The portable Windows version is distributed from the complete PyInstaller directory at `dist/BylickiLabsWebSecurityInspector/`. The entire directory must be transferred unchanged. Individual files must not be copied in isolation.
