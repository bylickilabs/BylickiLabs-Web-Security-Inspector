...
This file defines the binding requirements, procedures, responsibilities, and quality standards for **Backup and Restore** within BylickiLabs Web Security Inspector.
...
The application must be closed before restoration. Database files must not be replaced during an active write operation.
