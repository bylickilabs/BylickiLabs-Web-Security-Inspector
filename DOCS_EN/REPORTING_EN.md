...
This file defines the binding requirements, procedures, responsibilities, and quality standards for **Reporting and Exports** within BylickiLabs Web Security Inspector.
...
- **JSON:** is defined, professionally assessed, and reviewed on a regular basis.
- **HTML:** is defined, professionally assessed, and reviewed on a regular basis.
- **CSV:** is defined, professionally assessed, and reviewed on a regular basis.
- **PDF:** is defined, professionally assessed, and reviewed on a regular basis.
- **SARIF 2.1.0:** is defined, professionally assessed, and reviewed on a regular basis.
...
| HTML | standalone business report |
| CSV | tabular processing |
| PDF | management and archival report |
| SARIF 2.1.0 | development and security integration |
