...
This file defines the binding requirements, procedures, responsibilities, and quality standards for **Settings Reference** within BylickiLabs Web Security Inspector.
...
- **Reproducible installation and reliable application startup on Windows:** is defined, professionally assessed, and reviewed on a regular basis.
- **Clear operating procedures for Scan Center, Dashboard, Findings, and Statistics:** is defined, professionally assessed, and reviewed on a regular basis.
- **Secure local storage of settings, scans, and reports:** is defined, professionally assessed, and reviewed on a regular basis.
- **Traceable troubleshooting, recovery, and support information:** is defined, professionally assessed, and reviewed on a regular basis.
- **Controlled use of optional external services and API keys:** is defined, professionally assessed, and reviewed on a regular basis.
- **Language:** is defined, professionally assessed, and reviewed on a regular basis.
- **Network timeout:** is defined, professionally assessed, and reviewed on a regular basis.
- **Measurement count:** is defined, professionally assessed, and reviewed on a regular basis.
- **Local storage:** is defined, professionally assessed, and reviewed on a regular basis.
- **Optional API services:** is defined, professionally assessed, and reviewed on a regular basis.
...
| Network timeout | maximum wait time for individual network requests |
| Measurement count | number of performance measurements |
| Local storage | enables SQLite scan history |
| PageSpeed | optional external analysis |
| Observatory | optional external HTTP assessment |
