...
This file defines the binding requirements, procedures, responsibilities, and quality standards for **Frequently Asked Questions** within BylickiLabs Web Security Inspector.
...
### Does the executable require a separate Python installation?

No. A correctly built PyInstaller version contains the required runtime components.

### Where is scan history stored?

By default in `data/scan_history.sqlite3`.

### Can external APIs be disabled?

Yes. PageSpeed Insights and MDN HTTP Observatory are optional.

### Does the application replace a manual security assessment?

No. Automated results require professional review.

### Which targets may be assessed?

Owned systems and explicitly authorized targets.
