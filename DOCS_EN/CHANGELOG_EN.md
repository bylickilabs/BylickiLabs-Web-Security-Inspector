...
This file defines the binding requirements, procedures, responsibilities, and quality standards for **Changelog** within BylickiLabs Web Security Inspector.
...
- **Version planning, release status, and traceable change records:** is defined, professionally assessed, and reviewed on a regular basis.
- **Compatibility, migration, and controlled publication:** is defined, professionally assessed, and reviewed on a regular basis.
- **Validation of release artifacts, build results, and version numbers:** is defined, professionally assessed, and reviewed on a regular basis.
- **Documentation of changes, limitations, and known risks:** is defined, professionally assessed, and reviewed on a regular basis.
- **Coordination between development, testing, security, and delivery:** is defined, professionally assessed, and reviewed on a regular basis.
...
- completely redesigned PySide6 user interface
- Dashboard, Scan Center, Findings, Statistics, History, Log, and Settings
- NumPy and SciPy analysis
- Matplotlib charts
- SQLite scan history
- exports to JSON, HTML, CSV, PDF, and SARIF
- automated Windows build scripts with PyInstaller
- German and English user interface

### Changed

- modularized scan engine
- changed risk scoring to a saturating assessment model
- optimized database access and result aggregation
- improved safe handling of dynamic content in the UI and reports
- improved handling of IP targets and DNS edge cases

### Fixed

- delays for IP-based targets
- special-character handling in HTML and PDF reports
- stability for empty measurement series and invalid external responses
