...
This file defines the binding requirements, procedures, responsibilities, and quality standards for **Scanner Modules** within BylickiLabs Web Security Inspector.
...
- **HTTP headers:** is defined, professionally assessed, and reviewed on a regular basis.
- **Cookies and CORS:** is defined, professionally assessed, and reviewed on a regular basis.
- **Forms and content:** is defined, professionally assessed, and reviewed on a regular basis.
- **TLS and certificates:** is defined, professionally assessed, and reviewed on a regular basis.
- **DNS, email security, and performance:** is defined, professionally assessed, and reviewed on a regular basis.
...
|---|---|
| `http_headers.py` | security headers and response information |
| `cookies.py` | cookie attributes |
| `cors.py` | cross-origin configuration |
| `forms.py` | forms and transmission paths |
| `content.py` | HTML content and resources |
| `tls_scan.py` | TLS and certificates |
| `dns_scan.py` | DNS and email security |
| `performance.py` | response-time measurements |
| `resources.py` | public standard and deployment files |
| `external.py` | optional external services |
