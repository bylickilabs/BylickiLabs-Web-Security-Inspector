...
This file defines the binding requirements, procedures, responsibilities, and quality standards for **Release Process** within BylickiLabs Web Security Inspector.
...
1. Freeze the feature scope.
2. Update version numbers.
3. Run the complete test and Ruff suite.
4. Produce the Windows build.
5. Manually validate the application and exports.
6. Generate checksums.
7. Update the changelog and release notes.
8. Publish the tag and release.
9. Provide artifacts from the official source.
