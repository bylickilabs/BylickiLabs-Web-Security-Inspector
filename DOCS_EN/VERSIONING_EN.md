...
This file defines the binding requirements, procedures, responsibilities, and quality standards for **Versioning Policy** within BylickiLabs Web Security Inspector.
...
The project uses a scheme based on Semantic Versioning:

```text
MAJOR.MINOR.PATCH
```

- **MAJOR:** incompatible architecture or functionality changes
- **MINOR:** backward-compatible features and major extensions
- **PATCH:** bug fixes, security updates, and smaller optimizations
